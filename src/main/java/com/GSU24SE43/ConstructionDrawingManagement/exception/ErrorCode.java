...
public enum ErrorCode {
    ...
    ACCESS_NOT_FOUND(10045, "Access not found", HttpStatus.BAD_REQUEST),
    VERSION_NOT_FOUND(10046, "Version not found", HttpStatus.BAD_REQUEST),
    TASK_PARENT_NOT_FOUND(10047, "Task parent not found", HttpStatus.BAD_REQUEST),
    TYPE_NOT_BLANK(10048, "Type Cannot Be Blank", HttpStatus.BAD_REQUEST),
    STATUS_NOT_BLANK(10049, "Status Cannot Be Blank", HttpStatus.BAD_REQUEST),
    DRAWING_NOT_FOUND(10050, "Drawing Not Found", HttpStatus.NOT_FOUND),
    STAFF_OR_ACCOUNT_NOT_FOUND(10051, "Staff Or Account Not Found", HttpStatus.BAD_REQUEST),
    ONLY_ADMIN_CREATE_PROJECT(10052, "Only Admin Can Create Projects", HttpStatus.UNAUTHORIZED),
    EMAIL_SEND_NOT_BLANK(10053, "Emails To Be Sent Cannot Be Blank", HttpStatus.BAD_REQUEST),
    EMAIL_CONTENT_NOT_BLANK(10054, "Either subject, body, or attachments must not be blank or empty", HttpStatus.BAD_REQUEST),
    INVALID_URL(10055, "URL must be valid", HttpStatus.BAD_REQUEST),
    SEND_MAIL_FAILED(10056, "Mail Sent Failed", HttpStatus.INTERNAL_SERVER_ERROR),
    ILLEGAL_STATE_EXCEPTION(10057, "Cannot Invoke or Support Such Method", HttpStatus.INTERNAL_SERVER_ERROR),
    WRONG_BEGINDATE_OR_ENDDATE(10058,"The end date must be after the beginning date",HttpStatus.BAD_REQUEST),
